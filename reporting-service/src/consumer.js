                ...
                try {
                    ...
                    switch (event) {
                        ...
                        case 'ticket_priority_updated':
                            await Ticket.findByIdAndUpdate(ticketId, { priority: data.priority });
                            break;

                        case 'ticket_assigned':
                            await Ticket.findByIdAndUpdate(ticketId, { assignedAgentId: data.assignedAgentId });
                            break;

                        default:
                            console.log("⚠️ Reporting Service received an unknown event type:", event);
                    }
                    channel.ack(msg);
                } catch (err) {
